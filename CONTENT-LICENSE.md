...
Licence umožňuje obsah kopírovat, upravovat a dále šířit, včetně komerčního využití,
při uvedení autora, zdroje, odkazu na licenci a informace o případných změnách.

Licence CC BY 4.0 se nevztahuje na loga institucí, video Policie České republiky
(`public/videos/policie.mp4`) ani na jiné označené materiály třetích stran.

- Licenční podmínky CC BY 4.0: https://creativecommons.org/licenses/by/4.0/deed.cs
- Licenční podmínky na webu projektu: https://www.lakrim.cz/licencni-podminky/
- Zdrojový kód softwaru je poskytován pod licencí MIT (soubor `LICENSE`).
